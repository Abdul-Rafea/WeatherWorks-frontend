...
function LandingPage() {
    return (
        <div className="w-full flex flex-col justify-center items-center">
            <header className="w-full flex justify-center items-center pr-4 pt-1">
                <nav className="w-full flex justify-between items-center">
                    <div className="w-1/4 grid grid-rows-2 place-items-center">
                        <img src="src\assets\Wasabi X logo.png" alt="Wasabi X logo" className="w-1/2 row-span-1"/>
                        <h2 className="font-iceberg text-base relative bottom-2 row-span-2">Wasabi X</h2>
                    </div>
            ...
            <div className="-mt-2 w-full h-auto flex justify-center items-center flex-col bg-lightGreen p-3 pt-10 pb-15">
                ...
                <div className="flex justify-center items-center flex-col gap-2">
                    ...
                    <p className="text-3xl text-center font-iceberg">OR</p>
            ...
            <div className="-mt-1 w-full h-auto flex justify-center items-center flex-col bg-midGreen p-3 gap-3 pt-10
                sm:p-5">
                 <h1 className="w-full text-2xl text-offWhite font-iceberg">Dive Deeper Into Features: -</h1>
                <DescriptionBox
                icon = {<svg
                    width={50}
                    height={50}
            ...
            <footer className="w-full bg-lightGreen flex justify-center items-center flex-wrap gap-3 p-3">
                <h1 className="text-2xl text-center font-iceberg">Get it on: -</h1>
                <div className="w-full flex justify-center items-center flex-wrap gap-5">
                    <button className="w-1/2 flex justify-center items-center bg-midGreen p-2 rounded-3xl gap-2">
                        <svg
                        width={40}
                        height={40}
                        viewBox="0 0 24 24"
                        ...
                        <h2 className="text-lg text-offWhite font-iceberg">iOS</h2>
                    </button>
                    <button className="w-1/2 bg-midGreen p-2 rounded-3xl flex justify-center items-center gap-2">
                        <svg
                            width={40}
                            height={40}
                            viewBox="0 0 192 192"
                        ...
                        <h2 className="text-lg text-offWhite font-iceberg">Google Play</h2>
                    </button>
                    <button className="w-1/2 bg-darkGreen p-2 rounded-3xl flex justify-center items-center gap-2">
                            <svg
                                width={40}
                                height={40}
                                viewBox="0 0 32 32"
                        ...
                        <h2 className="text-lg text-offWhite font-iceberg">Web</h2>
                    </button>
                </div>
                <div className="w-9/10 h-1 bg-darkGreen mt-5 mb-5"></div>
                <div className="flex items-center gap-5">
                    <img src="src\assets\Wasabi X logo.png" alt="wasabi X logo" className="w-1/4" />
                    <div>
                        <h3 className="text-xl">&copy; Wasabi X</h3>
                        <h3 className="text-xl">All rights reserved.</h3>
                    </div>
                </div>
            </footer>
        </div>
