...
function NotificationFrame(){
    ...
    return(
        <div className="bg-midGreen w-8/10 absolute top-0 flex justify-center items-center gap-2 rounded-b-2xl p-3">
            { isError? (
                  <svg
                    width={40}
                    height={40}
            ...
            (
                <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                >
                    <path className="stroke-green-500"
                    d="M7.29417 12.9577L10.5048 16.1681L17.6729 9"
                    strokeWidth="2.5"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    />
                    <circle cx={12} cy={12} r={10} className="stroke-green-500" strokeWidth={2} />
                </svg>
            ) 
            }
